       <x-guest-layout>
           ...
           <div class="bg-white lg:rounded-2xl dark:bg-[#111111]">
                       ...
                       <div class="grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-[30px] grid gap-x-10 gap-y-7 mb-6">
                           ...
                           <div
                               ...
                               <h3
                                   ...
                                   <a href="#ex1" rel="modal:open">How to Own Your Audience by Creating an
                                       Email
                                       List.</a>
                               </h3>
                           </div>
                           ...
                           <div
                               ...
                               <h3
                                   class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                                   <a href="#ex4" rel="modal:open">Top 10 Toolkits for Deep Learning in
                                       2021.</a>
                               </h3>
                           </div>
                           <!-- blog items four  end -->
                           ...
                           <div
                               ...
                               <h3
                                   class="text-lg font-medium dark:text-white duration-300 transition cursor-pointer mt-3 pr-4 hover:text-[#FA5252] dark:hover:text-[#FA5252]">
                                   <a href="#ex5" rel="modal:open">How to Own Your Audience by Creating an
                                       Email
                                       List.</a>
                               </h3>
                           </div>
               ...
               <footer class="overflow-hidden rounded-b-2xl bg-[#f8fbfb] dark:bg-[#212425]">
                   <p class="text-center py-6 text-gray-lite dark:text-color-910"> © 2022 All Rights Reserved by
           ...
           <div id="ex1" class="modal-container modal">
               <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
                   <div class="pr-3 pb-2">
                       ...
                       <h2 class="dark:text-white sm:text-3xl mt-2 font-medium"> How to Own Your Audience by
                           Creating
                           an Email List. </h2>
                       <p class="dark:text-white font-normal text-[15px] sm:text-sm my-4"> Lorem ipsum dolor, sit
                           amet
                           ...
                           rerum sit non. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga
                           consequatur
                           delectus porro sapiente molestias, magni quasi sed, enim corporis omnis doloremque
                           soluta
                           inventore dolorum consequuntur quo obcaecati rerum sit non. </p>
                       <p class="dark:text-white font-normal text-[15px] sm:text-sm my-4"> Lorem ipsum dolor, sit
                           amet
                           consectetur adipisicing elit. Fuga consequatur delectus porro sapiente molestias, magni
                           quasi sed, enim corporis omnis doloremque soluta inventore dolorum consetur quo
                           obcaecati
                           rerum sit non. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga
                           consequatur
                           delectus porro sapiente molestias, magni quasi sed, sit amet consectetur adipisicing
                           elit.
                   ...
                   <div class="rounded-lg mt-6 bg-gradient-to-r from-[#FA5252] to-[#DD2476] p-[1px] mr-3">
                       <div class="dark:bg-[#232220] bg-[#ffffff] flex p-4 rounded-lg">
                           ...
                           <div class="pl-5">
                               ...
                               <p class="dark:text-white md:pr-16"> Lorem, ipsum dolor sit amet consectetur
                                   adipisicing
           ...
           <div id="ex2" class="modal-container modal">
               <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
                   <div class="pr-3 pb-2">
                       ...
                       <h2 class="dark:text-white sm:text-3xl mt-2 font-medium"> Everything You Need to Know About
                           Web
                           Accessibility. </h2>
                       <p class="dark:text-white font-normal text-[15px] sm:text-sm my-4"> Lorem ipsum dolor, sit
                           amet
           ...
           <div id="ex4" class="modal-container modal">
               <div class="dark:scrollbarDark scrollbarLight overflow-y-scroll max-h-[60vh] lg:max-h-[80vh]">
                   <div class="pr-3 pb-2">
                       ...
                       <h2 class="dark:text-white sm:text-3xl mt-2 font-medium"> Top 10 Toolkits for Deep Learning
                           in
                           2021. </h2>
                       <p class="dark:text-white font-normal text-[15px] sm:text-sm my-4"> Lorem ipsum dolor, sit
                           amet

                        ...
                        <div class="w-full lg:w-[40%] xl:w-[30%] space-y-6">
                            <div
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]"> +452 666 386
                                    </p>
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]"> +452 666 386
                                    </p>
                                </div>
                            ...
                            <div
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]">
                                        support@gmail.com
                                    </p>
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]">
                                        example@gmail.com
                            ...
                            <div
                                ...
                                <div class="space-y-2">
                                    ...
                                    <p class="text-gray-lite text-lg dark:text-[#A6A6A6]"> Maount View,
                                        Oval
                                    </p>
